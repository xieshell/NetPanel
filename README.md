我是一个无线通信工程师，平时也写写程序。平时用SpeedTest和Cellular-Z来测网速。我打算模仿SpeedTest用C#来写一个开源的通用库，大家可以用这个库来写自己的speedTest。库包含Server和Client端，可以指定测试协议，支持TCP/UDP/HTTP/RTCP等。我给这个开源库起名叫myNetPanel。
